...
PicturePerfect.prototype.extractDynamicSourceOptions = function(el){
  return {
    ...
    dynamicBackgroundUrlDensity       : el.getAttribute('dynamic-background-url-density') || window.devicePixelRatio,
    dynamicBackgroundUrl              : el.getAttribute('dynamic-background-url') || "",
...
PicturePerfect.prototype.updateSources = function(img){
  ...
  elements.forEach(function(node){
    ...
    ['dynamicSrc','dynamicBackgroundUrl'].forEach(function(key){
      if(options[key]){
